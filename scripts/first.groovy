...
def sql = Sql.newInstance("jdbc:h2:file:/tmp/things", "sa", "sa", "org.h2.Driver")  // 'file' keyword is optional
...
JdbcConnectionPool cp = JdbcConnectionPool.create("jdbc:h2:file:/tmp/test", "sa", "sa")
